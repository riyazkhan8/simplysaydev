...
#$conf['advagg_root_dir_prefix'] = 's3://s3fs-public/';
 ...
 *
 */
$drupal_hash_salt = '8lh425Dy9BZ5Me-awq4yMUBkdQ4rdsihtlt4nBpzXRc';
 ...
 * for you.
 */
$base_url = 'https://dev.simplysay.sg';  // NO trailing slash!
//$base_url = (drupal_is_https() ? 'https' : 'http') . '://dev.simplysay.sg';
 ...
 */
$cookie_domain = '.dev.simplysay.sg';
