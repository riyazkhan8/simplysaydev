ABOUT JI QUICKBOOKS MODULE
---------------------------------
This library was taken from QuickBooks but modified a little. Minor bug fixes and
additions were made to tailor more to how JI QuickBooks and Drupal needed. Please
download ji-quickbooks.com/sdk/qbosdk3260.zip instead of from QuickBooks.

The notes below this section have been left here but may not apply to your instance.
Please make sure to have the PHP OAuth extension installed on your server. You can
always run a quick <?php phpinfo(); ?> to confirm OAuth is installed - this is the
prefered way since phpinfo() gives you actual run time information you can rely on.
