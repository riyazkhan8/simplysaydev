...
(function (exports) {
  ...
  var CARD_ORIENTATION = {
    landscape: {
      ...
      inlayLeft: {
        objects: [
          {type: "textbox", left: 30, top: 37, width: 600, maxHeight: 435}
        ]
      },
      inlayRight: {
        objects: [
          {type: "textbox", left: 30, top: 37, width: 600, maxHeight: 110},
    ...
    portrait: {
      ...
      inlayLeft: {
        objects: [
          {type: "textbox", left: 30, top: 37, width: 440, maxHeight: 610},
        ]
      },
      inlayRight: {
        objects: [
          {type: "textbox", left: 30, top: 37, width: 440, maxHeight: 145},
          {type: "textbox", left: 30, top: 222, width: 440, maxHeight: 225},
