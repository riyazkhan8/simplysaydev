...
<head>
  ...
  <?php print $styles; ?>
  <link rel = "stylesheet" type = "text/css" href = "<?php echo $base_url;?>/<?php print drupal_get_path('theme',$GLOBALS['theme']);?>/css/listnav.css" />
...
<!-- <script src="<?php echo $base_url;?>/<?php print drupal_get_path('theme',$GLOBALS['theme']);?>/js/commerce-payment-ajax.js"></script> -->
</body>
</html>
