                    ...
                    <div class="card_preview_inlay_right">
                            <div class="canvas-content">
                                <div class="content-area content-area-sm" >                                    
                                    <img src="<?php echo $base_path;?><?php print drupal_get_path('theme',$GLOBALS['theme']);?>/images/preview.png" id="canvas2" width="400" height="175" class="getCanvas2" >
                                </div>
                                 <div class="content-area content-area-md">                                    
                                    <img src="<?php echo $base_path;?><?php print drupal_get_path('theme',$GLOBALS['theme']);?>/images/preview.png" id="canvas3" width="400" height="175" class="getCanvas3" >
                                </div>
                                 <div class="content-area content-area-sm">                                    
                                    <img src="<?php echo $base_path;?><?php print drupal_get_path('theme',$GLOBALS['theme']);?>/images/preview.png" id="canvas4" width="400" height="175" class="getCanvas4" >
                                </div>
                            </div>
                    </div>
