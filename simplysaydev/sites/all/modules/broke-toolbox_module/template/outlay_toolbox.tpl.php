...
<div class="main_container" id="outlay-container">
    ...
    <div class="editorContainer">
        ...
        <div class="documentContainer">
            ...
            <div id="outlay-canvas" class="pageContainer <?=$orientation?>">
                <span id="outlay-loader" class="canvas-loader"><img class="loader-spinner" src="https://s3-stage.simplysay.sg/s3fs-public/site_images/toolboxload.gif"><span class="loader-message">loading</span></span>
            </div>
        </div>
            ...
            <aside class="objectPanel" >
                <ul class="nav-tabs" role="tablist" data-tabgroup="second-tab-group">
                    ...
                    <? if($tid != CANVAS_PHOTO): ?>
                        ...
                        <li role="presentation">
                            <a href="#backgrounds-tool" aria-controls="backgrounds-tool" role="tab" data-toggle="tab">Backgrounds</a>
                        </li>
                        <li role="presentation">
                            <a href="#clipart-tool" aria-controls="clipart-tool" role="tab" data-toggle="tab">Clipart</a>
                        </li>
                        <li role="presentation">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="photos-tool">
                        <p>Add photos from your device or social networks Facebook & Instagram.</p>
                        <p>Photos will be displayed in the gallery below. You can drag these across to your canvas and position, resize or crop them to makethe perfect card.</p>
...
<script>
    jQuery( document ).ready(function() {
        ...
        createSimplySayEditor({
            ...
            emojiPath: "<?=file_create_url('public://emoji').'/smiley'?>",
            emojiGallery: [
                <? for ($i=1; $i < 12; $i++) { ?>
                "<?=$i?>.png",
                <? } ?>
            ...
            bgPath: "https://s3-stage.simplysay.sg/s3fs-public/clipart/backgrounds/",
            bgGallery: [
                "Background-1.png",
                "Background-10.png",
                "Background-11.png",
            ...
            clipartPath: "https://s3-stage.simplysay.sg/s3fs-public/clipart/objects/",
            clipartGallery: [
                "Balloon-1.png",
                "Balloon-2.png",
                "Balloon-4.png",
