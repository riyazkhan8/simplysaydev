...
<div class="main_container admin_portrait_tool">
        <div class="tool_1">
            <div class="container">
                <div class="row">
                     <!-- <div class="col-sm-12">
                    ...
                    <div class=" col-sm-6 gap-right">
                        <div class="canvas_left_space outlay_can_board">
                            ...
                            <div id="right-menu">
                             ...
                             <canvas id="canvas" width="500" height="661"></canvas>
                          </div>
                          </div>  
                    </div>
                              ...
                              <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="colorText-tool">
                                    ...
                                    <div class="select-bg-color-section clearfix">
                                        ...
                                        <!-- <input type="text" name="col" id="col" hidden="hidden"> -->
                                            <!-- <img src="<?php echo $base_path;?><?php print drupal_get_path('theme',$GLOBALS['theme']);?>/images/color-palate.jpg"/> -->
                                            <ul>
                                    ...
                                    <div class="tool-title"><h3>Select Text Color, Typeface and Font</h3></div>
                                                <a href="javascript:void(0)" class="btn rect-btn" id="addTextCanvas" 
                                                onclick="addTextCanvas()">Add Textbox</a>
                                    ...
                                    <div class="select-bg-color-section clearfix">
                                        <form>
                                            ...
                                            <div class="form-group" id="cardimagegroup" style="display:none">
                                                ...
                                                <input type="file" class="form-control" name="cardimage" id="card_sample_image" >
                                    ...
                                    <!-- <div class="col-sm-12">
                                        <div class="blue-round-btns single-btn">
                                            <button type="button" class="btn-blue btn-blue-nxt">Next</button>
                                            <a href="javascript:void(0)" class="btn-blue-nxt">Next</a>
                                        </div>
                                    </div>  -->                                
                                </div>
                                <div role="tabpanel" class="tab-pane" id="emoji-tool">
                                    ...
                                    <!-- <div class="green-round-btns clearfix">
                                        <ul class="pull-right">
                                            <li><a href="javascript:void(0)"  id="saveCanvasJson" onclick="saveCanvasJson('admin_save','admin');">Save</a></li>
                                            <li><a href="javascript:void(0)" onclick="undo()">Undo</a></li>
                                            <li><a href="javascript:void(0)" id="clearCanvas" onclick="clearCanvas()">Clear All</a></li>
                                        </ul>
                                    </div> -->

                                    <!-- <div class="col-sm-12">
                                        <div class="round-btns double-btn">
                                            <button type="button" class="btn-blue btn-blue-prv">Prev</button>
                                            <button type="button" class="btn-blue btn-blue-nxt">Next</button>
                                        </div>
                                        <div class="blue-round-btns double-btn">
                                            <a href="javascript:void(0)" class="btn-blue-prv">Prev</a>
                                            <a href="javascript:void(0)" class="btn-blue-nxt">Next</a>
                                        </div>
                                    </div> -->
                                </div>
                                <div role="tabpanel" class="tab-pane" id="photos-tool">
                                    ...
                                    <div class="photo-upload-section text-center clearfix">
                                        <div class="select-device">
                                            <h3>Select Photo From My Device</h3>
                                        ...
                                        <!-- <div class="select-social-media">
                                            <h3>Select Photo From My Social Media Account</h3>
                                    ...
                                    <!-- <div class="green-round-btns clearfix">
                                        <ul class="pull-right">
                                            ...
                                            <li><a href="javascript:void(0)" onclick="undo()">Undo</a></li>
                                            <li><a href="javascript:void(0)" id="clearCanvas" onclick="clearCanvas()">Clear All</a></li>
                                            <li><a href="javascript:void(0)" id="clearCanvas"
                                                    onclick="removeActive()">Delete</a></li>
                                        </ul> -->
                                    </div>
                                </div>
                              </div>                            
