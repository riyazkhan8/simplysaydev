...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#F1E33C","#00B0FF","#21A1DA","#2661AC","#264095"], 'array', ','),

    // startAnimationTime : int
    // length of initial animation
    startAnimationTime: kvLookup('startAnimationTime', config, dataset, 6000),
    ...
    refreshAnimationTime: kvLookup('refreshAnimationTime', config, dataset, 6000),
