...
<?php //print $output; 
    ...
    //print "<pre>"; print_r($product->field_card_sample_image['und'][0]['uri']);
    //exit;
?>

        <div class="col-sm-4">

                    <div class="featuredcard fcard-big">
                        <a href="<?php print $nodeurl; ?>">
                                <img src="<?php print $image_url; ?>" width="500" height="661" class="img-responsive">                           
