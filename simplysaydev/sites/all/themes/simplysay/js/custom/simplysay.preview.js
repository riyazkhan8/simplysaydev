...
//old
  ...
  function _pageTurner(id){
    ...
    var bookWrapper = $(pagesContainer.parents()[0]);
    bookWrapper.addClass("closed-front");
    ...
    pages.click(function _setPage() {
      ...
      if(page_num === 2){
        bookWrapper.addClass("closed-front");
        bookWrapper.removeClass("closed-rear");
      }else if( page_num === pages.length - 1){
        bookWrapper.removeClass("closed-front");
        bookWrapper.addClass("closed-rear");
      }else{
        bookWrapper.removeClass("closed-front");
        bookWrapper.removeClass("closed-rear");
      }
