...
fabric.util.object.extend(fabric.Canvas.prototype,{
  ...
  setTabbable: function(value) {
    ...
    // this.inputElement.setAttribute("tabindex",value);
    ...
    fabric.util.addListener(this.inputElement, 'focus', this.focused.bind(this));
    ...
    this.on("mouse:down", this.focused.bind(this))
