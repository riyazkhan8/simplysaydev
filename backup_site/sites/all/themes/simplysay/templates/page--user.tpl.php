...
// print "<pre>";print_r($node->type);exit;
  ...
  if (isset($_SESSION['user_redirect_session'])) {
    ...
    drupal_goto($_SESSION['user_redirect_session']);
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
                    <div class="profile_sidebar">
                                ...
                                ?>  <li class="<?php print $user_points_class; ?>"><a href="<?php print $user_points; ?>"><i class="fa fa-list-ol" aria-hidden="true"></i> Points</a></li>
                                    ...
                                    <li class="<?php print $saved_card_class; ?>"><a href="<?php print $saved_card; ?>"><i class="fa fa-file-image-o" aria-hidden="true"></i> Saved Designs</a></li>  
                                    <li class="<?php print $order_history_class; ?>"><a href="<?php print $order_history; ?>"><i class="fa fa-shopping-basket" aria-hidden="true"></i> Order History</a></li>       <li class="<?php print $address_book_class; ?>"><a href="<?php print $address_book; ?>"><i class="fa fa-address-card" aria-hidden="true"></i> Address Book</a></li>
                                    <li class="<?php print $account_edit_class; ?>"><a href="<?php print $account_edit; ?>"><i class="fa fa-cog" aria-hidden="true"></i> Settings</a></li>
    ...
    <section class="col-sm-9"<?php //print $content_column_class; ?>>
      ...
      <?php print render($title_prefix); ?>
        <?php if (arg(2) == 'addressbook' && arg(4)!='delete'): ?>
        	<?php drupal_set_title('Address Book'); ?>
            <h4 class="page-header">Address Book</h4> 
        <?php elseif(arg(2) == 'edit'): ?>
        	<?php drupal_set_title('Account Settings'); ?>
...
<?php if (arg(2) == 'orders' && arg(3) == 'items'): ?>
      <?php 

          $card_orientation = find_card_orientation(arg(4));

      ?>
      <?php if($card_orientation == 'portrait'):?>
      <div class="card_preview" style="display:none;">
      <input type="hidden" id ="item_id" value="<?php print arg(4);?>" />                  
            <?php print theme('order_card_preview'); ?>
      </div>
    <?php else:?>
     <div class="card_preview landscape" style="display:none;">
      <input type="hidden" id ="item_id" value="<?php print arg(4);?>" />                  
            <?php print theme('order_card_preview_landscape'); ?>
      </div>
      <?php endif; ?>
<?php endif; ?>
...
<script src="<?php echo $base_url;?>/<?php print drupal_get_path('theme',$GLOBALS['theme']);?>/js/jquery-listnav.js"></script>

<script type="text/javascript">
  jQuery('.addressbook-shipping-ul').listnav({
